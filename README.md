About types-aiobotocore-dynamodb-feedstock
==========================================
...
Summary: Type annotations for aiobotocore.DynamoDB 3.9.1 service generated with mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-aiobotocore-dynamodb-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-aiobotocore-dynamodb-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-aiobotocore-dynamodb
# for installing globally
pixi global install types-aiobotocore-dynamodb
```
...
It is possible to list all of the versions of `types-aiobotocore-dynamodb` available on your platform:
...
```
pixi search types-aiobotocore-dynamodb --channel conda-forge
```
